...
## Descripción
Hoy ha venido a hablar. Quería hablar. Hemos hablado.
De nuevo, hemos pactado condiones nuevas.
Condiciones de respeto. De restaurar la confianza. De implicarnos mutuamente.
Le enseñé mi sittuación financiera, ipso facto quiso compensarla con una transferencia. La devolví, gracias, pero no, no así.
Me hace falta, pero también saber qué significa, el problema, no fué sólo el dinero, sino no poder hablar.
Si de verdad ayudar quiere, hablar es el camino.

## Cosmogonía
### Musical
**Obra:** Elastic Heart
**Autor:** Sia Furler, Thomas Pentz, Andrew Swanson
**Intérprete:** Sia
<div class="aetheon-youtube">
  <iframe
    src="https://www.youtube-nocookie.com/embed/KWZGAExj-es"
    title="YouTube video"
    loading="lazy"
...
<div class="aetheon-youtube-link">
  <a href="https://www.youtube.com/watch?v=KWZGAExj-es"
     target="_blank"
